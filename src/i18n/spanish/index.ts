...
const summary = {
  title: "Resumen",
  description: [
    "Al ir a la vanguardia con la creación de soluciones transformadoras en entornos innovadores, impulsando el desarrollo de aplicaciones de React de última generación que revolucionan la industria.",
  ],
};
