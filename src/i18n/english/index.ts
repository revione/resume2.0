...
const summary = {
  title: "Summary",
  description: [
    // "I am an experienced web developer with over 7 years of experience, focusing on digital solutions for large-scale projects.",
    "As a leader at the forefront of creating transformative solutions within innovative environments, I am driving the development of cutting-edge React applications that are revolutionizing the industry.",
  ],
};
