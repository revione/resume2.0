...
const summary = {
  ...
  description: [
    "Als Experte in der vordersten Reihe bei der Schaffung von bahnbrechenden Lösungen in innovativen Umgebungen, treibe ich die Entwicklung von hochmodernen React-Anwendungen voran, die die Branche revolutionieren.",
  ],
};
